...
export function GlobalReserveStrip({ shifted = false }: { shifted?: boolean }) {
  ...
  return (
    <GlassPanel soft className={cn('pointer-events-none absolute left-1/2 top-[58px] z-20 hidden -translate-x-1/2 items-center gap-3 rounded-full px-3 py-2 transition-[margin] lg:flex', shifted && 'lg:ml-[206px]')} aria-label="Reservas fisiológicas globais">
