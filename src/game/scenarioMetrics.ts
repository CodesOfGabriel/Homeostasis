...
export const SCENARIO_METRICS = [
    ...
    { key: 'perfusionIndex', label: 'Perfusão sistêmica relativa', unit: '% basal', digits: 0, group: 'system', step: 'vitals', read: (p) => p.cardiovascular.perfusionIndex },
    ...
    { key: 'ghrelin', label: 'Grelina', unit: 'pg/mL', digits: 0, group: 'endocrine', step: 'vitals', read: (p) => p.hormones.ghrelin },
    { key: 'leptin', label: 'Leptina', unit: 'ng/mL', digits: 1, group: 'endocrine', step: 'vitals', read: (p) => p.hormones.leptin },
    { key: 'adiponectin', label: 'Adiponectina', unit: 'μg/mL', digits: 1, group: 'endocrine', step: 'vitals', read: (p) => p.hormones.adiponectin },
    { key: 't3', label: 'Triiodotironina (T3)', unit: 'ng/dL', digits: 1, group: 'endocrine', step: 'vitals', read: (p) => p.hormones.t3 },
    { key: 't4', label: 'Tiroxina (T4)', unit: 'μg/dL', digits: 1, group: 'endocrine', step: 'vitals', read: (p) => p.hormones.t4 },
    { key: 'tsh', label: 'TSH', unit: 'μIU/mL', digits: 1, group: 'endocrine', step: 'vitals', read: (p) => p.hormones.tsh },
    { key: 'orexigenicDrive', label: 'Drive orexígeno NPY/AgRP', unit: '%', digits: 0, group: 'endocrine', step: 'vitals', read: (p) => p.endocrine.orexigenicDrive * 100 },
    { key: 'anorexigenicDrive', label: 'Drive anorexígeno POMC/CART', unit: '%', digits: 0, group: 'endocrine', step: 'vitals', read: (p) => p.endocrine.anorexigenicDrive * 100 },
    { key: 'mtorActivity', label: 'Atividade PI3K–AKT–mTOR', unit: '%', digits: 0, group: 'cell', step: 'defense', read: (p) => p.cellularSignaling.mTorActivity },
