...
export const SCENARIO_DEFINITIONS: ScenarioDefinition[] = [
    ...
    },
    {
        ...
        choices: [
            ...
            {
                id: 'hyperosmolar-volume-only', label: 'Dar glucagon e restringir a correção da glicose',
                description: 'Tenta sustentar pressão com ADH, mas aumenta produção hepática de glicose durante diurese osmótica.',
                tradeoff: 'Conserva parte da água, porém mantém a causa do gradiente osmótico e da perda renal.',
                requirements: [],
    ...
    },
    {
        ...
        choices: [
            ...
            {
                id: 'alcohol-insulin-storage', label: 'Aplicar insulina porque a bebida “tem calorias”',
                description: 'Interpreta o álcool como refeição e retira a glicose que ainda sustenta cérebro e fígado.',
    ...
    },
    {
        ...
        choices: [
            ...
            {
                id: 'alcohol-night-insulin-sedation', label: 'Aplicar insulina e deixar dormir sem monitorização',
                description: 'Interpreta sonolência como repouso normal, retirando glicose e tônus compensatório sem avaliar ventilação.',
    ...
    },
    {
        ...
        choices: [
            ...
            {
                id: 'fasted-workout-insulin', label: 'Aplicar insulina para aumentar captação muscular',
                description: 'Retira glicose da circulação em plena suspeita de hipoglicemia de esforço.',
    ...
    },
    {
        ...
        choices: [
            ...
            {
                id: 'panic-adrenergic-perfusion', label: 'Aplicar adrenalina para corrigir a tontura',
    ...
    },
    {
        ...
        choices: [
            ...
            {
                id: 'hemorrhage-vagal-diuresis', label: 'Dar betabloqueador para reduzir a taquicardia',
                description: 'Trata a frequência compensatória antes de controlar a hemorragia ou restaurar retorno venoso.',
